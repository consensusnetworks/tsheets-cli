export const getDateStringForDaysAgo = (days) => {
...
export const parseResponseBodyToData = (responseBody) => {
    const parsedResponseBody = JSON.parse(responseBody);
    return parsedResponseBody;
}

export const parseResponseDataToObject = (responseData, objectName) => {
...
export const needsTokenRefresh = (user) => {
